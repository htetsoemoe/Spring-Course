...
public class DemoLog4jApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        loggerA.log(Level.FINE, "FIND Message from serviceA");
        ...
        loggerB.log(Level.FINE, "FIND Message from serviceB");
        ...
        loggerC.log(Level.FINE, "FIND Message from serviceC");
        ...
        loggerD.log(Level.FINE, "FIND Message from serviceD");
        ...
        loggerE.log(Level.FINE, "FIND Message from serviceE");
        ...
        loggerF.log(Level.FINE, "FIND Message from serviceF");
        loggerF.log(Level.FINEST, "FINEST Message from serviceF");
        loggerF.log(Level.ALL, "All Level Messages from serviceF");
    }
}
