package com.example.democompositeprimarykey.util;
...
public class JPAUtil {
    ...
    public static String url = "jdbc:h2:mem:mydatabase";
    public static String dbdriver = "org.h2.Driver";
    public static String username = "sa";
    public static String password = "lp";

//    public static String url = "jdbc:mysql://localhost:3306/testingCompositeKey";
